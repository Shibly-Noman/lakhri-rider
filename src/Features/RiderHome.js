...
import { View, Text, Modal, Image, Pressable, Linking, TouchableOpacity, ImageBackground, TextInput, CheckBox, ScrollView, StyleSheet, TouchableOpacityBase } from 'react-native'
...
function RiderHome({ navigation }) {
    ...
    const markIndividualDone = async (order) => {
        ...
        try {
            ...
            const { data } = await axios
                .patch(`https://peaceful-citadel-48843.herokuapp.com/payment/status/update/by?id=${overallOrderId}&productInfoid=${order._id}`, body, {
    ...
    const rateVendor = async () => {
        ...
        // try{
        //     // const {data} = await axios.get(`https://peaceful-citadel-48843.herokuapp.com/business/give/rating/:userID?businessID=617b71fe1debbc001697ee9b&rating=5&orderID=6188f71e7e609f0016a806bb`, {
        //         headers: {"Authorization": "Bearer "+ token}
        //     })
        //     setOrders(data);
        // }
            ...
            <Modal
                ...
                <View style={{
                    ...
                    <Text style={{
                        ...
                        paddingLeft: 10,
                        paddingRight: 10,
                    }}>Rate your experience with the vendor!</Text>
                    <View style={{
                        marginTop: 20,
                    }}>
                        <Rating
                            ...
                            <View key={index} style={{
                                ...
                                <View style={{ display: 'flex', flexDirection: 'row' }}>
                                    <View style={{
                                        ...
                                        <Text style={{
                                            ...
                                            color: '#0da5eb',
                                            fontWeight: 'bold',
                                        }}>{order.vendorID.organizationName}</Text>
                                        <Text
                                            style={{
                                                color: '#000',
                                            }}
                                        >{order.vendorID.organizationAddress}</Text>
                                        <Text style={{
                                            color: '#000',
                                        }}>{order.vendorID.phoneNumber}</Text>
                                        ...
                                        >
                                            ...
                                            <Ionicons style={{
                                                marginRight: 5,
                                            }} name="star-outline" size={12} color="#DfAf37" />
                                    ...
                                    >
                                        <TouchableOpacity style={{
                                            ...
                                            onPress={() => { triggerVendorCall(order.vendorID.phoneNumber) }}
                                        >
                                ...
                                <View style={{ display: 'flex', flexDirection: 'row', }}>
                                    ...
                                    >
                                        ...
                                        {(order.orderStatus == "delivered" || visibleActive == false) && (
                                            <TouchableOpacity style={{
                                                backgroundColor: '#fff',
                                                borderColor: '#0da5eb',
                                                borderWidth: 1,
